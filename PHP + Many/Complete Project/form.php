...
<body>
    ...
    <div class="bodyClass">
        ...
        <form method="post" class="container" role="form" action="add_user.php" enctype="multipart/form-data" >
            <table>
                <tr class="tag">
                ...
                <tr class="tag">
                    ...
                    <td><input type="password" name="password" class="details" value="<?php echo $password; ?>" required></td>
                </tr>
                <tr>
                    <td></td>
                    <td>
                ...
                <tr class="tag">
                    <td><label for="profilePicture">Upload your Profile Picture</label>
                        <span class="error">*</span>
                    </td>
                    <td><input type="file" name="profilePicture" class="details" accept="image/*" required></td>
