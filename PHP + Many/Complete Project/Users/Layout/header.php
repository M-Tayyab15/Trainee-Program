            ...
            <div class="w3-dropdown-hover">
              <button class="w3-button  w3-center w3-text-white w3-primary" style="margin: 0px 10px;">
                <div style="display: flex; flex-direction: column; align-items: center;">
                  ...
                  <p style="margin: 0; font-size: 12px; color: black;"><?php echo $_SESSION['username1']; ?></p>
                </div>
              </button>
              <div class="w3-dropdown-content w3-bar-block w3-card-4">
                <a href="logout_User.php" class="w3-bar-item w3-button">Logout</a>
              </div>
            </div>
          <?php else : ?>
            <a href="login_user.php" class="w3-button w3-small w3-margin-left">Login</a>
          <?php endif; ?>
        </div>
      </div>
    </div>