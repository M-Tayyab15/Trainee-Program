                ...
                ?>
                    <tr>
                        ...
                        <td style="background-color:<?php
                                                    echo ($grade == 'A++') ? 'darkgreen' : (($grade == 'A+') ? 'green' : (($grade == 'A') ? 'lightgreen' : (($grade == 'B') ? 'yellow' : (($grade == 'C') ? 'orange' :
                                                        'red'))));
                                                    ?>"><?php echo $grade; ?></td>
                    </tr>
                <?php } ?>
...
<?php } else { ?>
    ...
    <body>
        <table>
            ...
            <tbody>
        <tr>
            <td colspan="6" style="text-align: center;"><h1>No Record Found</h1></td>
        </tr>
    </tbody>
