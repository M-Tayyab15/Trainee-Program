...
function enqueue_owl_carousel_cdn() {
    // Enqueue Owl Carousel CSS from CDN
    ...
    // Initialize Owl Carousel (Optional, customize your options as needed)
...
add_action('wp_enqueue_scripts', 'enqueue_owl_carousel_cdn');
