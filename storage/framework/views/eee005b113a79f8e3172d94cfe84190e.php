            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white d-flex align-items-center" href="<?php echo e(route('cart')); ?>" title="cart">
                                <i class="bi bi-cart me-2"></i>
                                <span class="badge bg-primary" id="cart-count"><?php echo e($cartCount); ?></span>
                            </a>
                        </li>
...
</html><?php /**PATH F:\tayyab\example-app\resources\views/layouts.blade.php ENDPATH**/ ?>