            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white d-flex align-items-center" href="<?php echo e(url('/cart')); ?>" title="cart">
                                <i class="bi bi-cart me-2"></i>
                                <span class="badge bg-primary">0</span> <!-- Cart count (no functionality for now) -->
                            </a>
                        </li>
                        ...
                        <?php else: ?>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <a href="#" class="d-block mb-3">
                        <img src="<?php echo e(asset('images/Arsenal_FC.svg.png')); ?>" alt="Logo" class="img-fluid" style="width: 120px;">
                    </a>
...
<?php /**PATH F:\tayyab\example-app\resources\views/admin/layouts.blade.php ENDPATH**/ ?>