...
<body>
    <div class="email-container">
        <h1>Thank you for your order, <?php echo e($cart->user->name); ?>!</h1>
        <p>Your order has been successfully completed. Below are your order details:</p>

        <!-- Order ID Section -->
        <div class="order-id">
            <p><strong>Order ID:</strong> <?php echo e($cart->cart_id); ?></p>
        ...
        <ul>
            <?php $__currentLoopData = $cart->cartProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cartProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li>
                    <strong><?php echo e($cartProduct->product->name); ?></strong> 
                    <span>Quantity: <?php echo e($cartProduct->quantity); ?></span> - 
                    <span>Total: $<?php echo e($cartProduct->total_price); ?></span>
                </li>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </ul>
        <p class="total-amount">Total Amount: $<?php echo e($cart->total_amount); ?></p>
        
        <div class="payment-mode">
            <p><strong>Payment Mode:</strong> <?php echo e($cart->payment_mode); ?></p>
        </div>
...
<?php /**PATH F:\tayyab\example-app\resources\views/emails/order_confirmation.blade.php ENDPATH**/ ?>