...
@extends('layouts') <!-- Assuming you're using a layout file for common HTML structure -->
        ...
        <div class="row">
            ...
            <div class="col-md-6 d-flex justify-content-center mb-4 mb-md-0">
                <div class="product-gallery">
                    <img id="main-image" src="{{ url($mainImage->folder . '/' . $mainImage->filename) }}" class="main-image" alt="Product Image">
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="mt-4">
                    ...
                    <div class="small-images-container">
                        ...
                        <img src="{{ url($mainImage->folder . '/' . $mainImage->filename) }}" class="small-image selected" alt="Main Image Thumbnail" data-full-size="{{ url($mainImage->folder . '/' . $mainImage->filename) }}">

                        @foreach ($otherImages as $image)
                        <img src="{{ url($image->folder . '/' . $image->filename) }}" class="small-image" alt="Product Thumbnail" data-full-size="{{ url($image->folder . '/' . $image->filename) }}">
                        @endforeach
                    </div>
                </div>

                <form action="{{ route('cart.add', ['product_id' => $product->pro_id]) }}" method="POST" id="add-to-cart-form">
                    @csrf
